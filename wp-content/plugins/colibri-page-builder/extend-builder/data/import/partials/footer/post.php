<?php namespace ExtendBuilder; load_file_value('partial_data', array (
  ...
  array (
    ...
    array (
      ...
      'html' => '<div data-colibri-component="footer-parallax" data-colibri-id="13-f1" class="page-footer style-49 style-local-13-f1 position-relative">
  <!---->
...
',
    ...
    52 => 
    array (
      'desktop' => '#colibri .style-52 {
  text-align: center;
  height: auto;
  min-height: unset;
}
',
      'tablet' => '#colibri .style-52 {
  text-align: center;
  height: auto;
  min-height: unset;
}
',
      'mobile' => '#colibri .style-52 {
  text-align: center;
  height: auto;
  min-height: unset;
}
