          ...
          <div class="h-column h-column-container d-flex h-col-lg h-col-md h-col-auto style-66-outer style-local-16-m9-outer">
            <div data-colibri-id="16-m9" class="d-flex h-flex-basis h-column__inner h-px-lg-3 h-px-md-3 h-px-3 v-inner-lg-3 v-inner-md-3 v-inner-3 style-66 style-local-16-m9 position-relative">
              <div class="w-100 h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-start align-self-md-start align-self-start">
                ...
                <div data-colibri-id="16-m10" class="h-blog-meta style-67 style-local-16-m10 position-relative">
                  <div name="1" class="metadata-item">
                    <a class="h-global-transition" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>">
                      ...
                      <span class="h-blog-meta-text">
                      <?php echo get_the_author_meta( 'display_name', get_the_author_meta( 'ID' ) ); ?>
                      </span>
                    </a>
                    <span class="meta-separator">|</span>
                  </div>
                  <div name="2" class="metadata-item h-global-transition">
                    <a class="h-global-transition" href="<?php colibriwp_post_meta_date_url(); ?>">
                      <span class="h-svg-icon">
                        <!--Icon by Font Awesome (https://fontawesome.com)-->
                  ...
                  <div name="3" class="metadata-item">
                    <a class="h-global-transition" href="<?php colibriwp_post_meta_time_url(); ?>">
                      <span class="h-svg-icon">
                        <!--Icon by Font Awesome (https://fontawesome.com)-->
                  ...
                  <div name="4" class="metadata-item">
                    <a class="h-global-transition" href="<?php comments_link(); ?>">
                      <span class="h-svg-icon">
                        <!--Icon by Font Awesome (https://fontawesome.com)-->
