<?php namespace ExtendBuilder; load_file_value('partial_data', array (
  ...
  array (
    ...
    array (
      'css' => NULL,
      'json' => '{"name":"hop-footer","children":[{"name":"hop-section","props":{"anchor":false,"name":"Copyright","attrs":{"id":"copyright"}},"children":[{"name":"hop-row","children":[{"name":"hop-column","style":{"descendants":{"outer":{"columnWidth":{"type":"custom","custom":{"value":100,"unit":"%"}}}}},"children":[{"name":"hop-copyright","slot":null,"parentId":"11-f4","index":1,"id":"11-f5","partialId":11,"styleRef":61,"type":"footer"}],"id":"11-f4","parentId":"11-f3","partialId":11,"styleRef":60,"type":"footer"}],"parentId":"11-f2","index":0,"id":"11-f3","partialId":11,"styleRef":59,"type":"footer"}],"id":"11-f2","parentId":"11-f1","partialId":11,"styleRef":58,"type":"footer"}],"id":"11-f1","ui":{"isSelected":false,"isHovered":false},"type":"footer","partialId":11,"styleRef":57}',
      'meta' => 
      array (
        'styleRefs' => 
        array (
      ...
      'html' => '<div data-colibri-component="footer-parallax" data-colibri-id="11-f1" class="page-footer style-57 style-local-11-f1 position-relative">
  <!---->
...
',
    ...
    60 => 
    array (
      'desktop' => '#colibri .style-60 {
  text-align: center;
  height: auto;
  min-height: unset;
}
',
      'tablet' => '#colibri .style-60 {
  text-align: center;
  height: auto;
  min-height: unset;
}
',
      'mobile' => '#colibri .style-60 {
  text-align: center;
  height: auto;
  min-height: unset;
}
