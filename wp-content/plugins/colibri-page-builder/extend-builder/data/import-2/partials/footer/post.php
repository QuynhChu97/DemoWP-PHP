<?php namespace ExtendBuilder; load_file_value('partial_data', array (
  ...
  array (
    ...
    array (
      ...
      'html' => '<div data-colibri-component="footer-parallax" data-colibri-id="11-f1" class="page-footer style-61 style-local-11-f1 position-relative">
  <!---->
...
',
      'tablet' => '#colibri .style-64 {
  text-align: center;
  height: auto;
  min-height: unset;
}
',
      'mobile' => '#colibri .style-64 {
  text-align: center;
  height: auto;
  min-height: unset;
}
